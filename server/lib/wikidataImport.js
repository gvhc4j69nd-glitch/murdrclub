...
const REGION_KEYWORDS = {
  'us-ne': ['New York', 'New Jersey', 'Pennsylvania', 'Philadelphia', 'Massachusetts', 'Connecticut', 'Maine', 'Vermont', 'New Hampshire', 'Rhode Island', 'Delaware', 'Maryland'],
  'us-se': [', Georgia', 'Florida', 'Alabama', 'Mississippi', 'Tennessee', 'South Carolina', 'North Carolina', 'Virginia', 'Kentucky', 'Louisiana', 'New Orleans', 'Arkansas'],
  'us-mw': ['Ohio', 'Michigan', 'Detroit', 'Illinois', 'Chicago', 'Indiana', 'Wisconsin', 'Minnesota', 'Iowa', 'Missouri', 'Kansas', 'Nebraska'],
  ...
  canada: ['Canada', 'Canadian', 'Toronto', 'Vancouver', 'Montreal', 'Ottawa', 'Quebec', 'Trois-Rivieres', 'Edmonton', 'Saint John', 'Saanich', 'British Columbia', 'Ontario', 'Alberta', 'New Brunswick', 'Manitoba', 'Saskatchewan', 'Nova Scotia'],
  uk: ['United Kingdom', 'England', 'Scotland', 'Nairn', 'Wales', 'Northern Ireland', 'London', 'Belfast'],
  france: ['France', 'Paris', 'Calais'],
  iberia: ['Spain', 'Portugal', 'Madrid', 'Lisbon'],
  ireland: ['Republic of Ireland', 'Ireland', 'Dublin'],
  dach: ['Germany', 'Austria', 'Switzerland', 'Berlin'],
  nordic: ['Norway', 'Sweden', 'Denmark', 'Finland', 'Iceland'],
  russia: ['Russia', 'Moscow', 'Saint Petersburg'],
  'eastern-europe': ['Poland', 'Ukraine', 'Crimea', 'Lviv', 'Romania', 'Hungary', 'Czech', 'Slovakia', 'Bulgaria', 'Serbia', 'Belgrade', 'Croatia', 'Moldova', 'Belarus', 'Transnistria', 'Kosovo', 'Bosnia', 'Albania', 'Montenegro', 'Slovenia', 'Macedonia', 'Greece', 'Luhansk', 'Kyiv', 'Tbilisi'],
  italy: ['Italy', 'Rome'],
  baltics: ['Estonia', 'Latvia', 'Lithuania'],
  africa: ['Nigeria', 'Kenya', 'South Africa', 'Egypt', 'Uganda', 'Ghana', 'Ethiopia', 'Morocco', 'Gambia', 'Pretoria', 'Gauteng', 'Olivedale', 'Zimbabwe', 'Bulawayo', 'Namibia', 'Central African Republic'],
  'middle-east': ['Israel', 'Palestine', 'Turkey', 'Iran', 'Iraq', 'Saudi Arabia', 'Lebanon', 'Syria', 'Jordan', 'Sinai'],
  india: ['India', 'Delhi', 'Mumbai'],
  asia: ['China', 'Japan', 'South Korea', 'Philippines', 'Filipino', 'Thailand', 'Vietnam', 'Indonesia', 'Pakistan', 'Malaysia', 'Myanmar', 'Burma', 'Sagaing', 'Afghan', 'Bangladesh'],
  australia: ['Australia', 'New Zealand', 'Sydney'],
  ...
  'south-america': ['Brazil', 'São Paulo', 'Rio de Janeiro', 'Pará', 'Belém', 'Argentin', 'Venezuela', 'Colombia', 'Cartagena', 'Ecuador', 'Peru', 'Chile', 'Bolivia', 'Paraguay', 'Uruguay', 'Guyana', 'Suriname', 'Bogotá', 'Caracas'],
